...
const brands = {
    ...
    wasabou_kamakur_yumemiya: '享受日本抹茶與和式甜點間的美味結合。 日式茶屋，是抹茶與和式甜點的藝術交融之地，也是都市寧靜的一隅，給予人們一片空間去享受悠閒時光。 遠離喧囂，讓你再次看到夢想，這裡就是「夢見屋。 選用優質食材製作出美味的和式甜點及食物，配合傳統與日式時尚設計，給你一個忙裏偷閒﹑放鬆心情享受美食的私人空間。',
};
